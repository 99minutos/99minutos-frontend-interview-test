                ...
                <section className='p-10 w-96'>
                    ...
                    <div className='flex justify-around flex-col sm:flex-row'>
                        {mission.links && mission.links.video_link? 
                            <a href={mission.links.video_link} target="_blank" rel="noreferrer" className=' flex items-center justify-center py-2 px-8 my-2 border-2 border-yellow-400 rounded-lg text-yellow-400 hover:bg-yellow-400 hover:text-white'>Video</a>
                            :
                        ...
                        {mission.links && mission.links.article_link?  
                            <a href={mission.links.article_link} target="_blank" rel="noreferrer"> <div className='flex items-center justify-center my-2 py-2 px-8 border-2 border-yellow-400 rounded-lg text-yellow-400 hover:bg-yellow-400 hover:text-white'>Article</div> </a>
                            :
