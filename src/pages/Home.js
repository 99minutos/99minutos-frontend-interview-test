...
const Home = () => {
    ...
    return (
        <div className='bg-rocket h-full w-full'>
            <Navbar/>
            <div className='flex flex-row h-screen justify-center items-center mt-40'>
            <Link onClick={animateRocket} className='py-4 px-9 bg-yellow-400 text-white rounded text-lg m-3 hover:bg-yellow-500 hover:text-white'>
                All launches
            </Link>
